...
var RoleWhere = struct {
	...
	DeletedAt: whereHelpertime_Time{field: "\"roles\".\"deleted_at\""},
}
...
var (
	...
	roleGeneratedColumns      = []string{"id"}
)
...
func (q roleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for roles")
	}
...
func (q roleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count roles rows")
	}
...
func (q roleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if roles exists")
	}
...
func (o *Role) Permissions(mods ...qm.QueryMod) permissionQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"roles_permissions\" on \"permissions\".\"id\" = \"roles_permissions\".\"permission_id\""),
		qm.Where("\"roles_permissions\".\"role_id\"=?", o.ID),
	)
...
func (roleL) LoadPermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"permissions\".\"id\", \"permissions\".\"name\", \"permissions\".\"created_at\", \"permissions\".\"updated_at\", \"permissions\".\"deleted_at\", \"a\".\"role_id\""),
		qm.From("\"permissions\""),
		qm.InnerJoin("\"roles_permissions\" as \"a\" on \"permissions\".\"id\" = \"a\".\"permission_id\""),
...
func (roleL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"users\".\"id\", \"users\".\"created_at\", \"users\".\"updated_at\", \"users\".\"deleted_at\", \"a\".\"role_id\""),
		qm.From("\"users\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.CreatedAt, &one.UpdatedAt, &one.DeletedAt, &localJoinCol)
		if err != nil {
...
func (o *Role) RemovePermissions(ctx context.Context, exec boil.ContextExecutor, related ...*Permission) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"roles_permissions\" where \"role_id\" = $1 and \"permission_id\" in (%s)",
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from roles")
	}
...
func (o *Role) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no roles provided for insertion")
	}
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, roleGeneratedColumns)
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into roles")
	}
...
func (o *Role) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update roles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update roles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for roles")
	}
...
func (q roleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for roles")
	}
...
func (o *Role) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, roleGeneratedColumns)
		update = strmangle.SetComplement(update, roleGeneratedColumns)
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert roles")
	}
...
func (o *Role) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for roles")
	}
...
func (q roleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for roles")
	}
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if roles exists")
	}
