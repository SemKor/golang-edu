...
var ProductCategoryWhere = struct {
	...
	DeletedAt: whereHelpertime_Time{field: "\"product_categories\".\"deleted_at\""},
}
...
var (
	productCategoryAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at"}
	productCategoryColumnsWithoutDefault = []string{}
	productCategoryColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at"}
	productCategoryPrimaryKeyColumns     = []string{"id"}
	productCategoryGeneratedColumns      = []string{"id"}
)
...
func (q productCategoryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ProductCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for product_categories")
	}
...
func (q productCategoryQuery) All(ctx context.Context, exec boil.ContextExecutor) (ProductCategorySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to ProductCategory slice")
	}
...
func (q productCategoryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count product_categories rows")
	}
...
func (q productCategoryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if product_categories exists")
	}
...
func FindProductCategory(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ProductCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from product_categories")
	}
...
func (o *ProductCategory) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no product_categories provided for insertion")
	}
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, productCategoryGeneratedColumns)
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into product_categories")
	}
...
func (o *ProductCategory) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update product_categories, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update product_categories row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for product_categories")
	}
...
func (q productCategoryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for product_categories")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for product_categories")
	}
...
func (o ProductCategorySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in productCategory slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all productCategory")
	}
	return rowsAff, nil
}
...
func (o *ProductCategory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no product_categories provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, productCategoryGeneratedColumns)
		update = strmangle.SetComplement(update, productCategoryGeneratedColumns)

		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert product_categories, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert product_categories")
	}
...
func (o *ProductCategory) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no ProductCategory provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from product_categories")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for product_categories")
	}
...
func (q productCategoryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no productCategoryQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from product_categories")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for product_categories")
	}
...
func (o ProductCategorySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from productCategory slice")
	}
...
func (o *ProductCategorySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in ProductCategorySlice")
	}
...
func ProductCategoryExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if product_categories exists")
	}
