...
type Token struct {
	...
	ExpiresAt time.Time `boil:"expires_at" json:"expiresAt" toml:"expiresAt" yaml:"expiresAt"`
...
var TokenWhere = struct {
	...
	Token:     whereHelper__byte{field: "\"tokens\".\"token\""},
	...
	DeletedAt: whereHelpertime_Time{field: "\"tokens\".\"deleted_at\""},
}
...
var (
	tokenAllColumns            = []string{"id", "user_id", "token", "expires_at", "created_at", "updated_at", "deleted_at"}
	...
	tokenGeneratedColumns      = []string{"id"}
)
...
func (o *Token) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, tokenGeneratedColumns)
...
func (o *Token) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, tokenGeneratedColumns)
		update = strmangle.SetComplement(update, tokenGeneratedColumns)
