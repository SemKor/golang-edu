...
var (
	orderAllColumns            = []string{"id", "address", "created_at", "updated_at", "deleted_at"}
	orderColumnsWithoutDefault = []string{"address"}
	orderColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at"}
